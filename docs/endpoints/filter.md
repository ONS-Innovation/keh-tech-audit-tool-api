...
| `developed` | string | Filter by development type (for example `In-house`, `Partnership`, `Outsourced`) | False |
...
| `environments` | string | Environment names to filter by (comma-separated) | False |
